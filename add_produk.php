        ...
        <div class="container">
			<div class="row">
				<div class="col-lg-6 text-left"><br>
					...
					if(empty($idproduk) || empty($idkategori) || empty($namaproduk) || empty($satuan) || empty($stok) || empty($harga))
					{
					echo "<div class='alert alert-danger'><strong> Masih ada data yang kosong! </strong></div>";
					} else {
					mysql_query("INSERT INTO tbproduk (idproduk, idkategori, namaproduk, satuan, stok, harga)"."values('$idproduk', '$idkategori', '$namaproduk', '$satuan', '$stok', '$harga')") or die (mysql_error());
					...
					ID PRODUK
					<input id="idproduk" name="idproduk" class="form-control" placeholder="ID PRODUK"><br>
					NAMA KATEGORI
					<?php 
					...
					<br>
					NAMA PRODUK
					<input id="namaproduk" name="namaproduk" class="form-control" placeholder="NAMA PRODUK"><br>
					SATUAN 
					<input id="satuan" name="satuan" class="form-control" placeholder="SATUAN"><br>
					STOK 
					<input id="stok" name="stok" class="form-control" placeholder="STOK"><br>
					HARGA
					<input id="harga" name="harga" class="form-control" placeholder="HARGA"><br>
